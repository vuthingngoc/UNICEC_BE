...
namespace UniCEC.Business.Services.TeamInRoundSvc
{
    public interface ITeamInRoundService
    {
        ...
        public Task<List<ViewResultTeam>> GetResultTeamsInCompetition(string token, int competitionId, int top);
        public Task<List<ViewTeamInRound>> GetTopTeamsToNextRound(string token, int roundId, int top);
